...
## 🤖 Use of LLMs
You can use LLMs to help you generate code for this midterm, but you SHOULD NOT use it for your report. Even for your code, you may find it will lead you down the wrong path, as there are some common mistakes that the autocoders will fall into.  As such, this is one of those assignments, you will do best if you really take it step by step.

For the report, you must not use LLMs. Not only will they guide you down the wrong path, students in the past who have used them ended up with the wrong answers. This report requires you to demonstrate your knowledge. 
...
When you submit your midterm, please take the micro survey for research:  [https://neu.co1.qualtrics.com/jfe/form/SV_7ar1YIwOKxYrT1Q](https://neu.co1.qualtrics.com/jfe/form/SV_7ar1YIwOKxYrT1Q).
